...
const takePicture = async () => {
  ...
  return (
    <View style={styles.container}>
      ...
      :(
        <>
          <View style={{ width: '100%', flex:1, backgroundColor:"#fff", flexDirection:"column", justifyContent:"center", alignItems:"center",}}>
              <View style={{borderWidth:5}}>
                <Text style={{textAlign:"center"}}>Your Photo: </Text>
                <View style={{flexDirection:"column", alignItems:"center", justifyContent:"center"}}>
                  <Image source={{uri:takenImage}} style={{width:300,height:300, margin:16}}/>
                </View>
              </View>
