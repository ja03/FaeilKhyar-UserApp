  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={{marginTop:24}}>
        <Text style={styles.sectionText}>تأمل في تأثيرك الإيجابي, سجل تبرعاتك السابقة</Text>
              ...
              {prevDonations.map((donation)=>(
                <Link href={{
                  ...
                  params:{
                    ...
                    deviceCondition: donation.deviceCondition,
                    ...
                    donnerPhoneNumber: donation.donnerPhoneNumber,
