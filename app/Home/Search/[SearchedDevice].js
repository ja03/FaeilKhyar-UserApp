    ...
    return (
        ...
        <ScrollView>
            ...
            <View>
                ...
                <Text style={styles.Text}>نوع الجهاز: {local.searchType}</Text>
                <Text style={styles.Text}>موديل الجهاز: {local.searchModel}</Text>
                <Text style={styles.Text}>حجم الجهاز: {local.searchSize}</Text>

                {/* Hospital info */}
                <Text style={styles.headerText}>تواصل مع المستشفى</Text>
                <Text style={styles.Text}>رقم الهاتف: {local.searchHospitalPhoneNumber}</Text>
            </View>
            <View style={{borderTopWidth: 2, borderColor:"gray", borderRadius:2, marginTop:24}}>
                <Text style={styles.headerText}>طلب الجهاز</Text>
                <Text style={styles.Text}>يرجى ادخال رفم الهوية الطبية</Text>
                <TextInput
                ...
                <TouchableOpacity style={styles.btn2} onPress={handelRequest}>
                    <Link href={path}>
                        <Text style={{color:"#fff", textAlign:"center"}}>طلب الجهاز</Text>
                    </Link>
                </TouchableOpacity>
            </View>
